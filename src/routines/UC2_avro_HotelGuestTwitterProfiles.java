...
public class UC2_avro_HotelGuestTwitterProfiles 
{
	...
	public static void main(String[] args)
	{
		System.out.println("Welcome to Avro converter!");
			...
			try {
				UC2_avro_HotelGuestTwitterProfiles.readAvroFile("C:/Users/Public/Documents/USECASE2/Talend_input/Hotel_guest_profiles.avro");
				countfiles++;
	...
	static void readAvroFile(String strFile) throws IOException 
	{
		...
		Record record;
		File resultFile = new File("C:/Users/Public/Documents/USECASE2/Talend_output/Hotel_guest_profiles.csv");
